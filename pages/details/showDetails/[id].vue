<template>
  <div class="main-show-details-page">
    <v-container>
      <div
        class="main-show-details-page-upper-banner"
        :style="{
      ...
      <v-row class="main-content">
        <v-col cols="12" md="8" class="colom1-main-show-details">
          ...
          <div class="seasons">
            <div class="main-moving">
              ...
              <div class="moving-btns">
                <v-btn @click="swiper1.prev()">
                  <i class="fa-solid fa-arrow-left"></i>
                </v-btn>
                <v-btn @click="swiper1.next()">
            ...
            >
              <swiper-slide
                v-for="ved in detailData.seasons.filter(
              ...
              >
                <nuxt-link
                  :to="`seasons/${detailData.id}/${ved.season_number}`"
                  class="season-content"
                >
                  <div>
                    <div class="image">
                      <img
                        v-if="ved.poster_path"
                        :src="`https://image.tmdb.org/t/p/w185${ved.poster_path}`"
                      />
        ...
        <v-col cols="12" md="4" class="colom2-main-show-details">
          <div class="info">
            <div class="comp">
              <h1><i class="fa-regular fa-calendar"></i> Released Year</h1>
              <p>Frist Release : {{ detailData.first_air_date }}</p>
              <p>Last Release : {{ detailData.last_air_date }}</p>
            </div>
            <v-divider></v-divider>
            <div class="comp">
              <h1><i class="fa-regular fa-clock"></i>Seasons & Episodes</h1>
              <p>{{ detailData.number_of_seasons }} seasons</p>
              <p>{{ detailData.number_of_episodes }} episodes</p>
            </div>
            <v-divider></v-divider>
      ...
      <v-row>
        <v-col cols="12">
          <div class="main-reviews-show-details">
            <div class="no-data" v-if="!reviews.results.length">
              <h1>There Is No Reviews obout This Show</h1>
            </div>
            <div v-else>
              <div class="main-moving">
                <h1>Reviews</h1>
      ...
      <v-row>
        <v-col cols="12">
          <div class="main-vedios-show-details">
            <div class="no-data" v-if="!vedios.results.length">
              <h1>There Is No Vedios obout This Show</h1>
            </div>
            <div v-else>
              <div class="main-moving">
                <h1>Vedios</h1>
...
const [details, credits, videos, langs, revs, similars] = await Promise.all([
  useFetch(`https://api.themoviedb.org/3/tv/${showId}?language=en-US`, {
    headers,
  }),
  useFetch(`https://api.themoviedb.org/3/tv/${showId}/credits?language=en-US`, {
    headers,
  }),
  useFetch(`https://api.themoviedb.org/3/tv/${showId}/videos?language=en-US`, {
    headers,
  }),
  useFetch(`https://api.themoviedb.org/3/tv/${showId}/translations`, {
    headers,
  }),
  useFetch(
    `https://api.themoviedb.org/3/tv/${showId}/reviews?language=en-US&page=1`,
    { headers }
  ),
  useFetch(
...
onMounted(() => {
  ...
  fadeUp(".main-show-details-page-upper-banner");
  ...
  fadeDown(".main-reviews-show-details");
  fadeDown(".main-vedios-show-details");
  ...
  fadeleft(".colom1-main-show-details");
  ...
  faderight(".colom2-main-show-details");
});
</script>

<style lang="scss" scoped>
.main-show-details-page {
  background-color: rgb(var(--v-theme-bg8));

  .main-show-details-page-upper-banner {
    width: 100%;
    height: 90vh;
