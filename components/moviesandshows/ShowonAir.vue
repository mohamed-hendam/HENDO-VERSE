<template>
  <div class="moveis-shows-show-on-air">
    ...
    >
      <swiper-slide
        v-for="show in showOnAir.results"
        :key="show.id"
        class="swiper-slide"
      >
...
<script setup>
const containerRef9 = ref(null);
const swiper = useSwiper(containerRef9);
...
onMounted(() => {
  ...
  fadeUp(".moveis-shows-show-on-air");
});
</script>

<style lang="scss" scoped>
.moveis-shows-show-on-air {
  margin-bottom: 50px;
  .main-moving {
    display: flex;
