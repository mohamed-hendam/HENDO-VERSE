<template>
  <div class="moveis-shows-movies-nowplaying">
    ...
    >
      <swiper-slide
        v-for="movie in moviesNowPlaying.results"
        :key="movie.id"
        class="swiper-slide"
      >
...
const swiper = useSwiper(containerRef4);
...
onMounted(() => {
  ...
  fadeUp(".moveis-shows-movies-nowplaying");
});
</script>

<style lang="scss" scoped>
.moveis-shows-movies-nowplaying {
  margin-bottom: 50px;
  .main-moving {
    display: flex;
