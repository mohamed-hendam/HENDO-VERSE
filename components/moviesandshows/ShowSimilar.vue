<template>
  <div class="moveis-shows-shows-similar">
    ...
    >
      <swiper-slide
        ...
        class="swiper-slide"
      >
        <nuxt-link :to="`/details/showDetails/${movie.id}`" class="item">
          <div class="image">
...
onMounted(() => {
  const fadeUp = (selector, trigger = selector, start = "top 50%") => {
    $gsap.set(selector, { opacity: 0, y: 150 });
    $gsap.to(selector, {
      scrollTrigger: {
        trigger,
        start,
  ...
  fadeUp(".moveis-shows-shows-similar");
});
</script>

<style lang="scss" scoped>
.moveis-shows-shows-similar {
