<template>
  <div class="moveis-shows-shows-top-rated">
    ...
    >
      <swiper-slide
        v-for="show in showTopRated.results"
        :key="show.id"
        class="swiper-slide"
      >
...
<script setup>
const containerRef8 = ref(null);
const swiper = useSwiper(containerRef8);
...
onMounted(() => {
  ...
  fadeUp(".moveis-shows-shows-top-rated");
});
</script>

<style lang="scss" scoped>
.moveis-shows-shows-top-rated {
  margin-bottom: 50px;
  .main-moving {
    display: flex;
